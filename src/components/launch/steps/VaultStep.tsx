...
export function VaultStep({ control, errors }: VaultStepProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Security Info */}
      <div className="bg-accent-100 dark:bg-accent-500/10 border border-accent-500/40 dark:border-accent-500/30 rounded-lg px-4 py-3 space-y-2">
        <p className="text-sm text-accent-900 dark:text-accent-300 font-medium">How the vault works</p>
