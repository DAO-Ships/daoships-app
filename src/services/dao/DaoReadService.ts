// ═══════════════════════════════════════════════════════════════════════════
// DaoReadService — indexer-first reads with on-chain fallback
// ───────────────────────────────────────────────────────────────────────────
// Every read tries the indexer (Supabase) first and falls back to a direct
// on-chain read (the private *FromChain helpers) when the indexer is unavailable
// or a row is missing. logIndexerFallback surfaces a degraded indexer.
// ═══════════════════════════════════════════════════════════════════════════
...
export const daoReadService = new DaoReadService()
